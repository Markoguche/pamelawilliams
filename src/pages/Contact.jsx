...
const contactInfo = [
  { icon: '\u2709', label: 'Email', value: 'info@pamelawilliams.com' },
    ...
    <div>
      ...
      <section className="relative py-32 md:py-44 bg-black overflow-hidden" aria-label="Contact overview">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10">
          <FadeUp>
            <p className="text-gold-400 text-[10px] tracking-ultrawide uppercase mb-6 font-bold">Contact</p>
          </FadeUp>
          <RevealText>
            ...
            <div className="lg:col-span-2">
              <SlideLeft>
                <p className="text-black font-bold text-lg leading-relaxed mb-8">
                  Every stage she stands on, every brand she touches, and every project she curates reflects her signature: <span className="text-gold-500">excellence, creativity, impact, and unforgettable presence.</span>
                </p>
              </SlideLeft>
              <div className="space-y-5">
                {contactInfo.map((info, i) => (
                  <SlideLeft key={info.label} delay={i * 100}>
                    <div className="flex items-center gap-4 p-5 border border-black/5 hover:border-gold-500/50 transition-all duration-500">
                      <span className="text-gold-500 text-xl">{info.icon}</span>
                      <div>
              ...
              <SlideLeft delay={400}>
                <div className="mt-10 p-6 bg-black">
                  <p className="text-gold-400 text-[10px] tracking-ultrawide uppercase font-bold mb-2">Currently Booking</p>
                ...
                <form onSubmit={(e) => e.preventDefault()} className="space-y-6" aria-label="Contact form">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input id="c-name" type="text" required className="w-full px-4 py-3.5 border border-black/10 focus:border-gold-500 focus:ring-0 outline-none transition-all duration-300 text-black text-sm bg-transparent" placeholder="Your full name" />
                    </div>
                    <div>
                      <label htmlFor="c-email" className="block text-[10px] tracking-ultrawide uppercase text-black/40 font-bold mb-2">Email *</label>
                      <input id="c-email" type="email" required className="w-full px-4 py-3.5 border border-black/10 focus:border-gold-500 focus:ring-0 outline-none transition-all duration-300 text-black text-sm bg-transparent" placeholder="your@email.com" />
                    </div>
                  </div>
                  <div>
                    ...
                    <select id="c-service" className="w-full px-4 py-3.5 border border-black/10 focus:border-gold-500 focus:ring-0 outline-none transition-all duration-300 text-black text-sm bg-transparent">
                  ...
                  <div>
                    ...
                    <select id="c-budget" className="w-full px-4 py-3.5 border border-black/10 focus:border-gold-500 focus:ring-0 outline-none transition-all duration-300 text-black text-sm bg-transparent">
                  ...
                  <div>
                    ...
                    <textarea id="c-message" rows={6} required className="w-full px-4 py-3.5 border border-black/10 focus:border-gold-500 focus:ring-0 outline-none transition-all duration-300 text-black text-sm bg-transparent resize-none" placeholder="Tell me about your project, goals, and timeline..." />
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-black text-white py-4 text-[11px] font-bold tracking-ultrawide uppercase hover:bg-gold-500 hover:text-black transition-all duration-300 hover:shadow-[0_10px_40px_rgba(212,168,83,0.3)] hover:translate-y-[-2px]"
                  >
                    Send Message
                  </button>
