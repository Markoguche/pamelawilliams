...
const ExpertiseIcon = () => (
  <svg className="w-3.5 h-3.5 text-[#D4AF37] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
  </svg>
);

const PartnerIcon = () => (
  <svg className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const AwardIcon = ({ filled = false }) => (
  <svg className={`w-4 h-4 shrink-0 mt-0.5 ${filled ? 'text-[#D4AF37]' : 'text-[#D4AF37]/70'}`} fill={filled ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
...
const ArrowIcon = () => (
  <svg className="w-4 h-4 text-[#D4AF37]/50 group-hover:text-[#D4AF37] group-hover:translate-x-0.5 transition-all duration-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const awards2025 = [
  'Recognition of Excellence — Keynote Speaker at The High Value Woman: The Awakening',
  'Company of the Year — Aidos Creations (Servelead Group)',
  'Staff of the Year — Servelead Group of Companies',
  'Staff of the Year — Aidos Creations (Servelead Group)',
  'Sales Achievement Award — Servelead Group of Companies',
  'Most Punctual (Female) — Servelead Group of Companies',
  'Most Resourceful Staff — Servelead Group of Companies',
  'Award of Excellence in AI Content Creation Training — Dinovate Creative Academy',
];

const awards2024 = [
  'Most Punctual (Female) — Servelead Group of Companies',
  'Most Resourceful (Female) — Servelead Group of Companies',
  'Most Creative and Innovative — Servelead Group of Companies',
  'Staff of the Year (Aidos Creations) — Servelead Group of Companies',
...
const academicAwards = [
  'Best in Chemistry/Physics/Biology — Touchstone High School (2014)',
  'Best Graduating Student — Touchstone High School (2014)',
  'Most Sanitary Student (3 years in a row, 2012–2014) — Touchstone High School',
  'Best Graduating Student — Nobles International School (2008)',
];
    ...
    <div>
      ...
      <section className="relative min-h-[80vh] md:min-h-[100vh] flex items-end bg-black overflow-hidden" aria-label="About Pamela Williams">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 pb-16 md:pb-20 w-full">
          <FadeUp>
            <p className="text-[#D4AF37]/70 text-[10px] tracking-ultrawide uppercase mb-5 font-bold">About Me.</p>
          </FadeUp>
          <RevealText>
                ...
                <div className="lg:sticky lg:top-28">
                  <div className="w-full">
                    <img 
                      ...
                      className="w-full h-auto object-cover object-top rounded-sm" 
                      loading="lazy" 
      ...
      <section className="bg-black py-16 md:py-28" aria-label="Business ventures">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <FadeUp>
            <p className="text-[#D4AF37]/70 text-[10px] tracking-ultrawide uppercase mb-4 font-bold text-center">Ventures</p>
          </FadeUp>
          <FadeUp delay={80}>
          ...
          <div ref={venturesRef} className="space-y-3">
            {ventures.map((v) => (
              <article
                key={v.name}
                className="venture-card group grid md:grid-cols-12 gap-3 md:gap-6 items-center p-5 md:p-7 border border-white/8 hover:border-[#D4AF37]/40 transition-all duration-600"
                style={{ opacity: 0 }}
              >
                <div className="md:col-span-1">
                  <span className="text-[#D4AF37]/70 text-xl md:text-2xl font-black group-hover:text-[#D4AF37] transition-colors duration-600">{v.num}</span>
                </div>
                <div className="md:col-span-3">
                  <h3 className="text-lg font-bold text-white/90 group-hover:text-[#D4AF37] transition-colors duration-600">{v.name}</h3>
            ...
            <div className="mt-14 p-6 bg-black rounded-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {['Quarterly Training', '25 Centers', 'Brand Repositioning', 'Event Curation', 'Funding Support'].map((t) => (
                  <span key={t} className="px-4 py-1.5 bg-[#D4AF37] text-black text-[9px] font-bold tracking-ultrawide uppercase">{t}</span>
                ))}
              </div>
            </div>
          </FadeUp>
              ...
              <SlideLeft>
                <div className="lg:sticky lg:top-28">
                  ...
                  <div className="mt-5 p-5 bg-[#D4AF37] rounded-sm">
                    <p className="text-black font-black text-2xl mb-1">25+</p>
      ...
      <section className="bg-white py-14 md:py-20" aria-label="International partners">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <FadeUp>
            <p className="text-[#D4AF37] text-[10px] tracking-ultrawide uppercase mb-3 font-bold text-center">Global Reach</p>
          </FadeUp>
          <FadeUp delay={80}>
